...
<body>
    ...
    <div class="page home-page">
        ...
        <header class="hero has-dark-background">
                ...
                <div class="main-navigation">
                    ...
                    <div class="container">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <img src="<?php echo base_url().SITE_THEME; ?>assets/img/logo-inverted.png" alt="">
                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="<?php echo base_url(); ?>auth/signin" class="nav-link">
                        ...
                        <div class=" col-lg-5 col-md-8 col-sm-12 reg_box_home">
                            ...
                            <div class=" col-lg-12 col-md-12 col-sm-12 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="logo_in"> <img style=" width: 100%;" src="<?php echo base_url().SITE_THEME; ?>assets/img/logo_in.png" alt=""></div>
            ...
            <input  type="radio" name="gender" value="male" required <?php echo set_radio('gender', 'male'); ?> >
            ...
            <div class="background" >
                ...
                <div class="background-image">
                    ...
                    <img src="<?php echo base_url().SITE_THEME; ?>assets/img/hero-background-image-01.jpg" alt="">
        ...
        <section class="block">
            ...
            <div class="container">
                ...
                <div class="items list ">
                    ...
                    <div class="item col-md-6 col-sm-6" style="float: left;">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="image">
                                ...
                                <img src="<?php echo base_url(); ?>assets/img/img_not_avalable.jpg" >              
                            ...
                            <h4 class="location">
                             ...
                             <div class="additional-info">
                                    <ul>
                                        <li>
                                            <figure>Working as a</figure>
                                            <aside><?php if(isset($row->work_as)){echo ucwords($row->work_as);} else {echo "";} ?> </aside>
                                        </li>
 ...
 <a  href="<?php echo base_url();?>users/<?php echo $row->muser_id;?>" class="btn btn-primary text-caps m-l-10 btn-framed"></i>Send Interest</a>
                                        ...
                                        <a href="<?php echo base_url();?>users/<?php echo $row->muser_id;?>" class="btn btn-primary text-caps btn-framed m-l-10 "></i>View profile</a> </div>
                    ...
                    <a href="auth/login" class="item call-to-action">
                        ...
                        <div class="wrapper col-md-6 col-sm-6" style=" background: #fff; border: 1px solid #d9d9d9;}">
            ...
            <div class="container">
                ...
                <div class="d-flex align-items-center justify-content-around">
                    ...
                    <a href="#">
                        ...
                        <img src="<?php echo base_url().SITE_THEME; ?>assets/img/partner-1.png" alt="">

                    </a>

                    <a href="#">

                        <img src="<?php echo base_url().SITE_THEME; ?>assets/img/partner-2.png" alt="">

                    </a>

                    <a href="#">

                        <img src="<?php echo base_url().SITE_THEME; ?>assets/img/partner-3.png" alt="">

                    </a>

                    <a href="#">

                        <img src="<?php echo base_url().SITE_THEME; ?>assets/img/partner-4.png" alt="">

                    </a>

                    <a href="#">

                        <img src="<?php echo base_url().SITE_THEME; ?>assets/img/partner-5.png" alt="">
