                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea name="own_words" rows="5"  style="height:100px;width:100%;text-align:left;line-height:normal"><?php echo $this->muse->get_about_hobbies($this->tank_auth->get_user_id()) ?></textarea>
                                        </div>
                                    </div>
                                <!--end form-group-->
                                </div>
