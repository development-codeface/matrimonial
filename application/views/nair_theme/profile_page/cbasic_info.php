        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent-pills">
                ...
                <div class="tab-pane fade show active" id="one-pills" role="tabpanel" aria-labelledby="one-tab-pills">
                    ...
                    <form class="form form-submit" action="<?php echo base_url();?>update_profile/update_basic_info" method="post" >
                        ...
                        <section class=" signinbox">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="marital_status" id="martial_status" class="cstm_dropdown" required>
                            ...
                            <div class="row" id="children" style="display:none;">
                                ...
                                <label for="title" class="col-form-label required">No. of child edit</label>
                                        ...
                                        <select name="number_child" id="number_child" class="cstm_dropdown">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php $this->muse->gheight('heightto', 'cstm_dropdown' ,"id='heightto' required");?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php $this->muse->gweight('weight', '45 cstm_dropdown' ,"id='weight' required");?>
