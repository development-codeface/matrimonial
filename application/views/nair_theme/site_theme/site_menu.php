    ...
    <div class="hero-wrapper">
        ...
        <!-- <div class="secondary-navigation">
            <div class="container">
                <ul class="left">
                    <li>
                        <span> <span style="font-size: 1.25rem;
                ...
                <ul class="right" class="right" style="padding: 9px;">
                    <?php if(isset($this->session->userdata['logged_in_as'])&&($this->session->userdata['logged_in_as'] == 'admin')){
                        ?>
                    <li>
                        <a href="<?=base_url('auth/backToAdmin')?>/<?=$this->session->userdata['logged_in_from_id']?>">
                        <i class="fa fa-sign-in"></i>Back to Admin Login
                        </a>
                    </li>
                    <?php } ?>
        ...
        <div class="main-navigation">
            <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <?php if(isset($this->session->userdata['logged_in_as'])&&($this->session->userdata['logged_in_as'] == 'admin')){
                                ?>
                            <li class="nav-item">
                                <a href="<?=base_url('auth/backToAdmin')?>/<?=$this->session->userdata['logged_in_from_id']?>" class="nav-link">
                                <i class="fa fa-sign-in"></i> Back to Admin Login
                                </a>
                            </li>
                            <?php } ?>
                ...
                <?php if(isset($this->session->userdata['logged_in_as'])&&($this->session->userdata['logged_in_as'] == 'admin')){ ?>
                <h5 class="float-right">Admin Logged in as <b><?=$this->session->userdata['email']?></b></h5>
                <?php } ?>
                <!--end navbar-->
            </div>
            <!--end container-->
