                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <table class="table success table-bordered" style="margin-bottom:0px;" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <select name="day" id="day" class="cstm_dropdown" style="width:90px" required>
                                                            ...
                                                            <option value="31" label="31">31</option>
                                                                    ...
                                                                    <select name="month" id="month" class="cstm_dropdown"  style="width:100px" required>
                                                                    ...
                                                                    <select name="year" id="year" class="cstm_dropdown"  style="width:100px" required>
