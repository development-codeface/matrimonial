                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <ul class="nav navtab" id="myTab-pills" role="tablist" style="border: 1px solid #e1e1e1;">
                                            <li class="nav-item">
                                                <a href="<?php echo base_url();?>inbox/" class="nav-link active" id="one-tab-pills" role="tab" aria-controls="one-pills" aria-expanded="true">inbox</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo base_url();?>send/" class="nav-link" id="two-tab-pills" role="tab" aria-controls="two-pills"> Send Message </a>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="col-md-12">
                                                        ...
                                                        <?php if(isset($send_message) || size_of($send_message) > 0)
                                                        {
                                                            ...
                                                            <div class="message">
                                                                ...
                                                                <a href='<?php echo (base_url()."users/".$row->from_to); ?>'>
                                                                            <p> 
                                                                                <?php echo $this->muse->display_value('users', array('id'=> $row->from_to),'firstname' ); ?>
                                                                            </p> 
                                                                    </a>
