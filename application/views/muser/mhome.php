 ...
 if(isset($matches))

  {
...

    {
        ...
        $user_add = $row->ad_imagepath;

        $user_addurl = $row->ad_url;
...
<!--*********************************************************************************************************-->
            ...
            <section class="block">
                            ...
                            <a href="#"><?php if(isset($city)){echo ucwords($city);} else {echo "";}?> , <?php if(isset($state)){echo ucwords($state);} else {echo "";}?> </a>
                             ...
                             <dl style="padding-top:30px;">
                                            ...
                                            <?php } else {?>
                                                ...
                                                <a href="#" class=" " ><?php echo $whatsapp_no ?></a>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <a href="#" class="btn btn-secondary text-caps small" onclick="shortlistme(<?php echo $userid ?>)" ><i class="fa fa-star-o" aria-hidden="true"></i> Shortlist </a> 
                        ...
                        <form action="<?php echo base_url();?>send_message" method="post">
                            ...
                            <textarea style="max-height:70px;min-height:70px;max-width:805px;width: 100%" name="message"></textarea>
                ...
                <?php }?>
                      ...
                      <!--end Gallery Carousel--> </div>
                            ...
                            <?php
                            if(isset($user_add)) {?>
                            <section class="advertaisement">

                               

                                <p>
           
                                <a href="<?php echo $user_addurl ?>" target="_blank"><img style="width: 100%;height:350px;"  src="<?php echo $user_add ?>" alt=""> </a>
 ...
 <dt ><i class="fa fa-check-circle pf-matchico" aria-hidden="true"></i><label class="b-w">Smoking Habbit</label> </dt>
                                            ...
                                            <dd class="text-align-right dt-bg"><label class="b-w">Non Smoking</label> <i class="fa fa-check-circle pf-matchico" aria-hidden="true"></i></dd>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="items">
                            ...
                            <div class="item">
                                <div class="wrapper">
                                    <div class="image">
                                        <a href="<?php echo $user_addurl ?>" class="image-wrapper background-image">
                                            <?php if($user_add != NULL){?>
                                                <img src="<?php echo $user_add;?>"  alt="">
                                            <?php }else{?>                                                                    
