<div class="col-md-3 col-sm-5 mobile_none">
	...
	<div class="panel-body">
		<form action="<?php echo base_url();?>muser/filter_data" method="post" id="mfilter">
			...
			<div id="statecontainer"> <select id='state' name='state'> <option value=""> State </option></select></div>
			<!--<?php $this->address->city(); ?> -->
			<div id="citycontainer"> <select id='city' name='city'> <option value=""> City </option></select></div>
