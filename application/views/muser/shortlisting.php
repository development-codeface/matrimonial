                       ...
                       <!--============ Section Title===================================================================-->
                         <section class=" signinbox" id="matches_change">  
                            <?php if(isset($matches)){ ?> 
                                <h2> Shortlisted (<?php echo sizeof($matches->result()) ?> Profiles) </h2>
                            <?php } ?>
							...
							echo ucfirst($row->city). ",";
                                     ...
                                     <div class="padding-10">
                                            <a  href="#" class="btn  activeshortlist btn-primary text-caps m-l-10 btn-framed"><i class="fa fa-heart i-f-siz" aria-hidden="true"></i>
</a> 
