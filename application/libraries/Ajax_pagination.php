...
class Ajax_pagination{
	...
	var $next_link			= '<span aria-hidden="true"><i class="fa fa-chevron-right"></i></span><span class="sr-only">Next</span>';
	var $prev_link			= '<span aria-hidden="true"><i class="fa fa-chevron-left"></i></span><span class="sr-only">Previous</span>';
	var $last_link			= 'Last &rsaquo;';
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="page-pagination"><nav aria-label="Pagination"><ul class="pagination">';
